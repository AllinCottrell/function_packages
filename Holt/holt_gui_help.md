...
trend components of the time series, respectively. Setting these values
manually may be considered an "expert" (or pedagogical) option. If you
leave the `parms` selection at `automatic` gretl will estimate them for you.
...
to zero means that out-of-sample forecasts will be made instead.
