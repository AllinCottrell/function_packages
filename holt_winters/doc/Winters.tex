...
This package implements the forecasting method devised by P. R. Winters
\citeyearpar{winters60}, namely triple exponential smoothing with level,
trend and seasonal components.  It requires time-series data with a
...
qualifications noted in section~\ref{sec:daily}. If you want double
exponential smoothing (level and trend with no seasonal, as in
\citealt{holt57}), try the \textsf{Holt} package.

A prior version of this package (1.1) was written by Ignacio
...
forecast values, or 2 for a four-part plot of the level, trend,
...
\begin{itemize}
\item \texttt{v2.1}: Update to exploit ``virtual series'' in the
  bundle returned by \texttt{Winters()}.
